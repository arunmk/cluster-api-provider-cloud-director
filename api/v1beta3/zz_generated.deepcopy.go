...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudInitPhaseStatus) DeepCopyInto(out *CloudInitPhaseStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudInitPhaseStatus.
func (in *CloudInitPhaseStatus) DeepCopy() *CloudInitPhaseStatus {
	if in == nil {
		return nil
	}
	out := new(CloudInitPhaseStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VCDMachineSpec) DeepCopyInto(out *VCDMachineSpec) {
	*out = *in
	...
	if in.CloudInitPhases != nil {
		in, out := &in.CloudInitPhases, &out.CloudInitPhases
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *VCDMachineStatus) DeepCopyInto(out *VCDMachineStatus) {
	*out = *in
	...
	if in.CloudInitPhases != nil {
		in, out := &in.CloudInitPhases, &out.CloudInitPhases
		*out = make([]CloudInitPhaseStatus, len(*in))
		copy(*out, *in)
	}
}
